...
class RefreshTokenRepository:
    ...
    def get_by_jti(self, jti: str, *, for_update: bool = False) -> RefreshToken | None:
    ...
    def revoke_family(self, token_family: str) -> None:
        tokens = self.db.scalars(select(RefreshToken).where(RefreshToken.token_family == token_family, RefreshToken.revoked_at.is_(None))).all()
